      ...
      <section className="relative min-h-[85vh] md:min-h-[90vh] flex items-center" aria-label="Hero section">
        ...
        <div className="container-tx relative z-10 py-20">
          <div className="max-w-2xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-extrabold text-white leading-tight mb-5">
            ...
            <a
              ...
              className="flex items-center gap-3 mb-6 rounded-2xl px-5 py-4 text-[#0a2340] font-bold shadow-2xl transition-all hover:scale-[1.02] active:scale-100 w-full max-w-sm"
              style={{
            ...
            >
              ...
              <span className="flex-1 min-w-0">
                <span className="block text-xs font-bold uppercase tracking-wider text-[#0a2340]/70 leading-none mb-1">Emergency Towing — 24/7</span>
                <span className="block text-lg sm:text-xl font-heading font-extrabold leading-tight">{BUSINESS.phone}</span>
              </span>
              <span className="flex-shrink-0 text-xs font-black bg-[#0a2340] text-[#fef15f] rounded-full px-2.5 py-1.5 uppercase tracking-widest hidden sm:inline">24/7</span>
            </a>
