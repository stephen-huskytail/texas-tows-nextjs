...
// Revalidate this page every 12 hours so it stays reasonably fresh,
// and the daily cron job at midnight CST forces a full revalidation.
...
export default function BlogPage() {
  // Filter at render time — only posts with date <= today (CST) are shown
