...
export const metadata: Metadata = {
  ...
  description: "Texas Tows Inc. offers 15% off all towing and roadside assistance for active military, veterans, teachers, and first responders in Dallas, TX. Call (214) 704-6474.",
